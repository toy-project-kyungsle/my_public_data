...
| 우선순위 | 테마                                                                            | 왜 이게 먼저인가                                                                                                                        | 핵심가치                                                       | 갖춘 판단 기준                                                                                                                           |
| -------- | ------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
...
- 코드에서 어떻게 하면 안정적인 설계를 할 수 있는가?
  ...
  - 실패를 설계한다
    - 어떤 건 자동 재시도
    - 어떤 건 사용자 안내
    - 어떤 건 즉시 차단 + 로깅 + 고객센터 보내기
    - 점진적인 롤아웃 + 즉시 복구할 수 있는 포인트 설계
- **에러가 안 나게(또는 나도 안전하게) 만드는 설계/코딩 습관을 갖추는 것**

[P0/전문성과_안정성.md](docs/idea/P0/전문성과_안정성.md)
...
[P0/ai_협업_가속기_실제_방법.md](docs/idea/P0/ai_협업_가속기_실제_방법.md)
...
[P1/kpi_중심_사고.md](docs/idea/P1/kpi_중심_사고.md)
...
- 앱 성능을 개선하는 방법들을 찾아서 개선해본다
- 성능개선 때 측정하려고 했던 것 찾아서 실제로 측정보는 것이 좋아보인다

[P1/비즈니스_임팩트형_성능_ux.md](docs/idea/P1/비즈니스_임팩트형_성능_ux.md)
...
[P1/설계_트레이드오프_판단.md](docs/idea/P1/설계_트레이드오프_판단.md)
...
[P2/확장성_full_cycle_lite_be_인프라_이해_액션.md](docs/idea/P2/확장성_full_cycle_lite_be_인프라_이해_액션.md)
...
- 서드파티를 너무 믿지 말자
  - 결제사와 서드파티에 장애가 날 것이라고 확신해라. 응당 되어야 하는 것들이 안 될 때를 대비해 **로깅**을 해두어라

[P2/운영_관측_릴리즈_통합_운영체계_os_정리.md](docs/idea/P2/운영_관측_릴리즈_통합_운영체계_os_정리.md)
...
[P2/보안_리스크_방어.md](docs/idea/P2/보안_리스크_방어.md)
