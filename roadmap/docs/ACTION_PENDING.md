...
> [ACTION.md](ACTION.md) 에 이미 있는 항목은 포함하지 않는다.
...
- [코드_레벨_개선_액션플랜 §1](P0/plan/코드_개선/코드_레벨_개선_액션플랜.md)
...
- [ ] 우선 테스트 대상 선정:
  ...
  - 에러 핸들링 경로 — 장애 대응 코드
- [코드_레벨_개선_액션플랜 §2](P0/plan/코드_개선/코드_레벨_개선_액션플랜.md)
...
- [코드_레벨_개선_액션플랜 §3](P0/plan/코드_개선/코드_레벨_개선_액션플랜.md)
...
- [코드_레벨_개선_액션플랜 §4](P0/plan/코드_개선/코드_레벨_개선_액션플랜.md)
...
- [코드_레벨_개선_액션플랜 §5](P0/plan/코드_개선/코드_레벨_개선_액션플랜.md)
...
- [코드_레벨_개선_액션플랜 §6](P0/plan/코드_개선/코드_레벨_개선_액션플랜.md)
...
- [코드_레벨_개선_액션플랜 §7](P0/plan/코드_개선/코드_레벨_개선_액션플랜.md)
...
- [코드_레벨_개선_액션플랜 §10](P0/plan/코드_개선/코드_레벨_개선_액션플랜.md)
...
- [2026_프론트엔드_트렌드_채용공고_분석](2026_프론트엔드_트렌드_채용공고_분석.md)
...
- [2026_프론트엔드_트렌드_채용공고_분석 §2](2026_프론트엔드_트렌드_채용공고_분석.md)
...
- [ ] 청크별 사이즈 예산 설정
- [코드_레벨_개선_액션플랜 §9](P0/plan/코드_개선/코드_레벨_개선_액션플랜.md)
...
- [swr_설계_트레이드오프_판단_액션_플랜](swr_설계_트레이드오프_판단_액션_플랜.md)
...
- [코드_레벨_개선_액션플랜 §8](P0/plan/코드_개선/코드_레벨_개선_액션플랜.md)
